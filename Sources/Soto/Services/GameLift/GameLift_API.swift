...
public struct GameLift: AWSService {
    ...
    public func acceptMatch(_ input: AcceptMatchInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AcceptMatchOutput> {
        return self.client.execute(operation: "AcceptMatch", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func acceptMatch(_ input: AcceptMatchInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> AcceptMatchOutput {
        return try await self.client.execute(operation: "AcceptMatch", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func claimGameServer(_ input: ClaimGameServerInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ClaimGameServerOutput> {
        return self.client.execute(operation: "ClaimGameServer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func claimGameServer(_ input: ClaimGameServerInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ClaimGameServerOutput {
        return try await self.client.execute(operation: "ClaimGameServer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createAlias(_ input: CreateAliasInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateAliasOutput> {
    ...
    public func createAlias(_ input: CreateAliasInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateAliasOutput {
    ...
    public func createBuild(_ input: CreateBuildInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateBuildOutput> {
        return self.client.execute(operation: "CreateBuild", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func createBuild(_ input: CreateBuildInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateBuildOutput {
        return try await self.client.execute(operation: "CreateBuild", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createFleet(_ input: CreateFleetInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateFleetOutput> {
    ...
    public func createFleet(_ input: CreateFleetInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateFleetOutput {
    ...
    public func createGameServerGroup(_ input: CreateGameServerGroupInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateGameServerGroupOutput> {
        return self.client.execute(operation: "CreateGameServerGroup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func createGameServerGroup(_ input: CreateGameServerGroupInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateGameServerGroupOutput {
        return try await self.client.execute(operation: "CreateGameServerGroup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createGameSession(_ input: CreateGameSessionInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateGameSessionOutput> {
        return self.client.execute(operation: "CreateGameSession", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func createGameSession(_ input: CreateGameSessionInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateGameSessionOutput {
        return try await self.client.execute(operation: "CreateGameSession", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createGameSessionQueue(_ input: CreateGameSessionQueueInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateGameSessionQueueOutput> {
        return self.client.execute(operation: "CreateGameSessionQueue", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func createGameSessionQueue(_ input: CreateGameSessionQueueInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateGameSessionQueueOutput {
        return try await self.client.execute(operation: "CreateGameSessionQueue", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createMatchmakingConfiguration(_ input: CreateMatchmakingConfigurationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateMatchmakingConfigurationOutput> {
        return self.client.execute(operation: "CreateMatchmakingConfiguration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func createMatchmakingConfiguration(_ input: CreateMatchmakingConfigurationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateMatchmakingConfigurationOutput {
        return try await self.client.execute(operation: "CreateMatchmakingConfiguration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createMatchmakingRuleSet(_ input: CreateMatchmakingRuleSetInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateMatchmakingRuleSetOutput> {
        return self.client.execute(operation: "CreateMatchmakingRuleSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func createMatchmakingRuleSet(_ input: CreateMatchmakingRuleSetInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateMatchmakingRuleSetOutput {
        return try await self.client.execute(operation: "CreateMatchmakingRuleSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createPlayerSession(_ input: CreatePlayerSessionInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreatePlayerSessionOutput> {
        return self.client.execute(operation: "CreatePlayerSession", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func createPlayerSession(_ input: CreatePlayerSessionInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreatePlayerSessionOutput {
        return try await self.client.execute(operation: "CreatePlayerSession", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createPlayerSessions(_ input: CreatePlayerSessionsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreatePlayerSessionsOutput> {
        return self.client.execute(operation: "CreatePlayerSessions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func createPlayerSessions(_ input: CreatePlayerSessionsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreatePlayerSessionsOutput {
        return try await self.client.execute(operation: "CreatePlayerSessions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createScript(_ input: CreateScriptInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateScriptOutput> {
    ...
    public func createScript(_ input: CreateScriptInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateScriptOutput {
    ...
    public func createVpcPeeringAuthorization(_ input: CreateVpcPeeringAuthorizationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateVpcPeeringAuthorizationOutput> {
        return self.client.execute(operation: "CreateVpcPeeringAuthorization", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func createVpcPeeringAuthorization(_ input: CreateVpcPeeringAuthorizationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateVpcPeeringAuthorizationOutput {
        return try await self.client.execute(operation: "CreateVpcPeeringAuthorization", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createVpcPeeringConnection(_ input: CreateVpcPeeringConnectionInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateVpcPeeringConnectionOutput> {
    ...
    public func createVpcPeeringConnection(_ input: CreateVpcPeeringConnectionInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateVpcPeeringConnectionOutput {
    ...
    @discardableResult public func deleteAlias(_ input: DeleteAliasInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
    ...
    public func deleteAlias(_ input: DeleteAliasInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws {
    ...
    @discardableResult public func deleteBuild(_ input: DeleteBuildInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteBuild", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func deleteBuild(_ input: DeleteBuildInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws {
        return try await self.client.execute(operation: "DeleteBuild", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    @discardableResult public func deleteFleet(_ input: DeleteFleetInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
    ...
    public func deleteFleet(_ input: DeleteFleetInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws {
    ...
    public func deleteGameServerGroup(_ input: DeleteGameServerGroupInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteGameServerGroupOutput> {
        return self.client.execute(operation: "DeleteGameServerGroup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func deleteGameServerGroup(_ input: DeleteGameServerGroupInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteGameServerGroupOutput {
        return try await self.client.execute(operation: "DeleteGameServerGroup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteGameSessionQueue(_ input: DeleteGameSessionQueueInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteGameSessionQueueOutput> {
        return self.client.execute(operation: "DeleteGameSessionQueue", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func deleteGameSessionQueue(_ input: DeleteGameSessionQueueInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteGameSessionQueueOutput {
        return try await self.client.execute(operation: "DeleteGameSessionQueue", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteMatchmakingConfiguration(_ input: DeleteMatchmakingConfigurationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteMatchmakingConfigurationOutput> {
        return self.client.execute(operation: "DeleteMatchmakingConfiguration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func deleteMatchmakingConfiguration(_ input: DeleteMatchmakingConfigurationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteMatchmakingConfigurationOutput {
        return try await self.client.execute(operation: "DeleteMatchmakingConfiguration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteMatchmakingRuleSet(_ input: DeleteMatchmakingRuleSetInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteMatchmakingRuleSetOutput> {
        return self.client.execute(operation: "DeleteMatchmakingRuleSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func deleteMatchmakingRuleSet(_ input: DeleteMatchmakingRuleSetInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteMatchmakingRuleSetOutput {
        return try await self.client.execute(operation: "DeleteMatchmakingRuleSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    @discardableResult public func deleteScalingPolicy(_ input: DeleteScalingPolicyInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
    ...
    public func deleteScalingPolicy(_ input: DeleteScalingPolicyInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws {
    ...
    @discardableResult public func deleteScript(_ input: DeleteScriptInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteScript", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func deleteScript(_ input: DeleteScriptInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws {
        return try await self.client.execute(operation: "DeleteScript", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteVpcPeeringAuthorization(_ input: DeleteVpcPeeringAuthorizationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteVpcPeeringAuthorizationOutput> {
        return self.client.execute(operation: "DeleteVpcPeeringAuthorization", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func deleteVpcPeeringAuthorization(_ input: DeleteVpcPeeringAuthorizationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteVpcPeeringAuthorizationOutput {
        return try await self.client.execute(operation: "DeleteVpcPeeringAuthorization", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteVpcPeeringConnection(_ input: DeleteVpcPeeringConnectionInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteVpcPeeringConnectionOutput> {
    ...
    public func deleteVpcPeeringConnection(_ input: DeleteVpcPeeringConnectionInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteVpcPeeringConnectionOutput {
    ...
    @discardableResult public func deregisterGameServer(_ input: DeregisterGameServerInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeregisterGameServer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func deregisterGameServer(_ input: DeregisterGameServerInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws {
        return try await self.client.execute(operation: "DeregisterGameServer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeAlias(_ input: DescribeAliasInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeAliasOutput> {
        return self.client.execute(operation: "DescribeAlias", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeAlias(_ input: DescribeAliasInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeAliasOutput {
        return try await self.client.execute(operation: "DescribeAlias", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeBuild(_ input: DescribeBuildInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeBuildOutput> {
        return self.client.execute(operation: "DescribeBuild", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeBuild(_ input: DescribeBuildInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeBuildOutput {
        return try await self.client.execute(operation: "DescribeBuild", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeEC2InstanceLimits(_ input: DescribeEC2InstanceLimitsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeEC2InstanceLimitsOutput> {
        return self.client.execute(operation: "DescribeEC2InstanceLimits", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeEC2InstanceLimits(_ input: DescribeEC2InstanceLimitsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeEC2InstanceLimitsOutput {
        return try await self.client.execute(operation: "DescribeEC2InstanceLimits", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeFleetAttributes(_ input: DescribeFleetAttributesInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeFleetAttributesOutput> {
        return self.client.execute(operation: "DescribeFleetAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeFleetAttributes(_ input: DescribeFleetAttributesInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeFleetAttributesOutput {
        return try await self.client.execute(operation: "DescribeFleetAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeFleetCapacity(_ input: DescribeFleetCapacityInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeFleetCapacityOutput> {
        return self.client.execute(operation: "DescribeFleetCapacity", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeFleetCapacity(_ input: DescribeFleetCapacityInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeFleetCapacityOutput {
        return try await self.client.execute(operation: "DescribeFleetCapacity", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeFleetEvents(_ input: DescribeFleetEventsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeFleetEventsOutput> {
        return self.client.execute(operation: "DescribeFleetEvents", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeFleetEvents(_ input: DescribeFleetEventsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeFleetEventsOutput {
        return try await self.client.execute(operation: "DescribeFleetEvents", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeFleetPortSettings(_ input: DescribeFleetPortSettingsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeFleetPortSettingsOutput> {
        return self.client.execute(operation: "DescribeFleetPortSettings", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeFleetPortSettings(_ input: DescribeFleetPortSettingsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeFleetPortSettingsOutput {
        return try await self.client.execute(operation: "DescribeFleetPortSettings", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeFleetUtilization(_ input: DescribeFleetUtilizationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeFleetUtilizationOutput> {
        return self.client.execute(operation: "DescribeFleetUtilization", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeFleetUtilization(_ input: DescribeFleetUtilizationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeFleetUtilizationOutput {
        return try await self.client.execute(operation: "DescribeFleetUtilization", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeGameServer(_ input: DescribeGameServerInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeGameServerOutput> {
        return self.client.execute(operation: "DescribeGameServer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeGameServer(_ input: DescribeGameServerInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeGameServerOutput {
        return try await self.client.execute(operation: "DescribeGameServer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeGameServerGroup(_ input: DescribeGameServerGroupInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeGameServerGroupOutput> {
        return self.client.execute(operation: "DescribeGameServerGroup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeGameServerGroup(_ input: DescribeGameServerGroupInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeGameServerGroupOutput {
        return try await self.client.execute(operation: "DescribeGameServerGroup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeGameServerInstances(_ input: DescribeGameServerInstancesInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeGameServerInstancesOutput> {
        return self.client.execute(operation: "DescribeGameServerInstances", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeGameServerInstances(_ input: DescribeGameServerInstancesInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeGameServerInstancesOutput {
        return try await self.client.execute(operation: "DescribeGameServerInstances", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeGameSessionDetails(_ input: DescribeGameSessionDetailsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeGameSessionDetailsOutput> {
        return self.client.execute(operation: "DescribeGameSessionDetails", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeGameSessionDetails(_ input: DescribeGameSessionDetailsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeGameSessionDetailsOutput {
        return try await self.client.execute(operation: "DescribeGameSessionDetails", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeGameSessionPlacement(_ input: DescribeGameSessionPlacementInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeGameSessionPlacementOutput> {
        return self.client.execute(operation: "DescribeGameSessionPlacement", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeGameSessionPlacement(_ input: DescribeGameSessionPlacementInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeGameSessionPlacementOutput {
        return try await self.client.execute(operation: "DescribeGameSessionPlacement", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeGameSessionQueues(_ input: DescribeGameSessionQueuesInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeGameSessionQueuesOutput> {
        return self.client.execute(operation: "DescribeGameSessionQueues", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeGameSessionQueues(_ input: DescribeGameSessionQueuesInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeGameSessionQueuesOutput {
        return try await self.client.execute(operation: "DescribeGameSessionQueues", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeGameSessions(_ input: DescribeGameSessionsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeGameSessionsOutput> {
        return self.client.execute(operation: "DescribeGameSessions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeGameSessions(_ input: DescribeGameSessionsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeGameSessionsOutput {
        return try await self.client.execute(operation: "DescribeGameSessions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeInstances(_ input: DescribeInstancesInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeInstancesOutput> {
    ...
    public func describeInstances(_ input: DescribeInstancesInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeInstancesOutput {
    ...
    public func describeMatchmaking(_ input: DescribeMatchmakingInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeMatchmakingOutput> {
        return self.client.execute(operation: "DescribeMatchmaking", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeMatchmaking(_ input: DescribeMatchmakingInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeMatchmakingOutput {
        return try await self.client.execute(operation: "DescribeMatchmaking", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeMatchmakingConfigurations(_ input: DescribeMatchmakingConfigurationsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeMatchmakingConfigurationsOutput> {
        return self.client.execute(operation: "DescribeMatchmakingConfigurations", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeMatchmakingConfigurations(_ input: DescribeMatchmakingConfigurationsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeMatchmakingConfigurationsOutput {
        return try await self.client.execute(operation: "DescribeMatchmakingConfigurations", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Retrieves the details for FlexMatch matchmaking rule sets. You can request all existing rule sets for the Region, or provide a list of one or more rule set names. When requesting multiple items, use the pagination parameters to retrieve results as a set of sequential pages. If successful, a rule set is returned for each requested name.   Learn more     Build a Rule Set     Related operations     CreateMatchmakingConfiguration     DescribeMatchmakingConfigurations     UpdateMatchmakingConfiguration     DeleteMatchmakingConfiguration     CreateMatchmakingRuleSet     DescribeMatchmakingRuleSets     ValidateMatchmakingRuleSet     DeleteMatchmakingRuleSet
    public func describeMatchmakingRuleSets(_ input: DescribeMatchmakingRuleSetsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeMatchmakingRuleSetsOutput> {
        return self.client.execute(operation: "DescribeMatchmakingRuleSets", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeMatchmakingRuleSets(_ input: DescribeMatchmakingRuleSetsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeMatchmakingRuleSetsOutput {
        return try await self.client.execute(operation: "DescribeMatchmakingRuleSets", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describePlayerSessions(_ input: DescribePlayerSessionsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribePlayerSessionsOutput> {
        return self.client.execute(operation: "DescribePlayerSessions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describePlayerSessions(_ input: DescribePlayerSessionsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribePlayerSessionsOutput {
        return try await self.client.execute(operation: "DescribePlayerSessions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeRuntimeConfiguration(_ input: DescribeRuntimeConfigurationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeRuntimeConfigurationOutput> {
        return self.client.execute(operation: "DescribeRuntimeConfiguration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeRuntimeConfiguration(_ input: DescribeRuntimeConfigurationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeRuntimeConfigurationOutput {
        return try await self.client.execute(operation: "DescribeRuntimeConfiguration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeScalingPolicies(_ input: DescribeScalingPoliciesInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeScalingPoliciesOutput> {
    ...
    public func describeScalingPolicies(_ input: DescribeScalingPoliciesInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeScalingPoliciesOutput {
    ...
    public func describeScript(_ input: DescribeScriptInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeScriptOutput> {
        return self.client.execute(operation: "DescribeScript", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeScript(_ input: DescribeScriptInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeScriptOutput {
        return try await self.client.execute(operation: "DescribeScript", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeVpcPeeringAuthorizations(_ input: DescribeVpcPeeringAuthorizationsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeVpcPeeringAuthorizationsOutput> {
        return self.client.execute(operation: "DescribeVpcPeeringAuthorizations", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func describeVpcPeeringAuthorizations(_ input: DescribeVpcPeeringAuthorizationsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeVpcPeeringAuthorizationsOutput {
        return try await self.client.execute(operation: "DescribeVpcPeeringAuthorizations", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeVpcPeeringConnections(_ input: DescribeVpcPeeringConnectionsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeVpcPeeringConnectionsOutput> {
    ...
    public func describeVpcPeeringConnections(_ input: DescribeVpcPeeringConnectionsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeVpcPeeringConnectionsOutput {
    ...
    public func getGameSessionLogUrl(_ input: GetGameSessionLogUrlInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetGameSessionLogUrlOutput> {
        return self.client.execute(operation: "GetGameSessionLogUrl", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func getGameSessionLogUrl(_ input: GetGameSessionLogUrlInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetGameSessionLogUrlOutput {
        return try await self.client.execute(operation: "GetGameSessionLogUrl", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getInstanceAccess(_ input: GetInstanceAccessInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetInstanceAccessOutput> {
        return self.client.execute(operation: "GetInstanceAccess", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func getInstanceAccess(_ input: GetInstanceAccessInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetInstanceAccessOutput {
        return try await self.client.execute(operation: "GetInstanceAccess", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listAliases(_ input: ListAliasesInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListAliasesOutput> {
    ...
    public func listAliases(_ input: ListAliasesInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListAliasesOutput {
    ...
    public func listFleets(_ input: ListFleetsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListFleetsOutput> {
        return self.client.execute(operation: "ListFleets", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func listFleets(_ input: ListFleetsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListFleetsOutput {
        return try await self.client.execute(operation: "ListFleets", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listGameServerGroups(_ input: ListGameServerGroupsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListGameServerGroupsOutput> {
        return self.client.execute(operation: "ListGameServerGroups", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func listGameServerGroups(_ input: ListGameServerGroupsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListGameServerGroupsOutput {
        return try await self.client.execute(operation: "ListGameServerGroups", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listGameServers(_ input: ListGameServersInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListGameServersOutput> {
        return self.client.execute(operation: "ListGameServers", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func listGameServers(_ input: ListGameServersInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListGameServersOutput {
        return try await self.client.execute(operation: "ListGameServers", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listScripts(_ input: ListScriptsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListScriptsOutput> {
        return self.client.execute(operation: "ListScripts", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func listScripts(_ input: ListScriptsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListScriptsOutput {
        return try await self.client.execute(operation: "ListScripts", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func putScalingPolicy(_ input: PutScalingPolicyInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutScalingPolicyOutput> {
    ...
    public func putScalingPolicy(_ input: PutScalingPolicyInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> PutScalingPolicyOutput {
    ...
    public func registerGameServer(_ input: RegisterGameServerInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RegisterGameServerOutput> {
        return self.client.execute(operation: "RegisterGameServer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func registerGameServer(_ input: RegisterGameServerInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> RegisterGameServerOutput {
        return try await self.client.execute(operation: "RegisterGameServer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func requestUploadCredentials(_ input: RequestUploadCredentialsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RequestUploadCredentialsOutput> {
        return self.client.execute(operation: "RequestUploadCredentials", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func requestUploadCredentials(_ input: RequestUploadCredentialsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> RequestUploadCredentialsOutput {
        return try await self.client.execute(operation: "RequestUploadCredentials", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func resolveAlias(_ input: ResolveAliasInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ResolveAliasOutput> {
        return self.client.execute(operation: "ResolveAlias", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func resolveAlias(_ input: ResolveAliasInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ResolveAliasOutput {
        return try await self.client.execute(operation: "ResolveAlias", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func resumeGameServerGroup(_ input: ResumeGameServerGroupInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ResumeGameServerGroupOutput> {
        return self.client.execute(operation: "ResumeGameServerGroup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func resumeGameServerGroup(_ input: ResumeGameServerGroupInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ResumeGameServerGroupOutput {
        return try await self.client.execute(operation: "ResumeGameServerGroup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func searchGameSessions(_ input: SearchGameSessionsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SearchGameSessionsOutput> {
        return self.client.execute(operation: "SearchGameSessions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func searchGameSessions(_ input: SearchGameSessionsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> SearchGameSessionsOutput {
        return try await self.client.execute(operation: "SearchGameSessions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func startFleetActions(_ input: StartFleetActionsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartFleetActionsOutput> {
        return self.client.execute(operation: "StartFleetActions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func startFleetActions(_ input: StartFleetActionsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> StartFleetActionsOutput {
        return try await self.client.execute(operation: "StartFleetActions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func startGameSessionPlacement(_ input: StartGameSessionPlacementInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartGameSessionPlacementOutput> {
        return self.client.execute(operation: "StartGameSessionPlacement", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func startGameSessionPlacement(_ input: StartGameSessionPlacementInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> StartGameSessionPlacementOutput {
        return try await self.client.execute(operation: "StartGameSessionPlacement", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func startMatchBackfill(_ input: StartMatchBackfillInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartMatchBackfillOutput> {
        return self.client.execute(operation: "StartMatchBackfill", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func startMatchBackfill(_ input: StartMatchBackfillInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> StartMatchBackfillOutput {
        return try await self.client.execute(operation: "StartMatchBackfill", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func startMatchmaking(_ input: StartMatchmakingInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartMatchmakingOutput> {
        return self.client.execute(operation: "StartMatchmaking", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func startMatchmaking(_ input: StartMatchmakingInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> StartMatchmakingOutput {
        return try await self.client.execute(operation: "StartMatchmaking", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func stopFleetActions(_ input: StopFleetActionsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopFleetActionsOutput> {
        return self.client.execute(operation: "StopFleetActions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func stopFleetActions(_ input: StopFleetActionsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> StopFleetActionsOutput {
        return try await self.client.execute(operation: "StopFleetActions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func stopGameSessionPlacement(_ input: StopGameSessionPlacementInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopGameSessionPlacementOutput> {
        return self.client.execute(operation: "StopGameSessionPlacement", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func stopGameSessionPlacement(_ input: StopGameSessionPlacementInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> StopGameSessionPlacementOutput {
        return try await self.client.execute(operation: "StopGameSessionPlacement", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func stopMatchmaking(_ input: StopMatchmakingInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopMatchmakingOutput> {
        return self.client.execute(operation: "StopMatchmaking", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func stopMatchmaking(_ input: StopMatchmakingInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> StopMatchmakingOutput {
        return try await self.client.execute(operation: "StopMatchmaking", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func suspendGameServerGroup(_ input: SuspendGameServerGroupInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SuspendGameServerGroupOutput> {
        return self.client.execute(operation: "SuspendGameServerGroup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func suspendGameServerGroup(_ input: SuspendGameServerGroupInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> SuspendGameServerGroupOutput {
        return try await self.client.execute(operation: "SuspendGameServerGroup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateAlias(_ input: UpdateAliasInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateAliasOutput> {
    ...
    public func updateAlias(_ input: UpdateAliasInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateAliasOutput {
        return try await self.client.execute(operation: "UpdateAlias", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateBuild(_ input: UpdateBuildInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateBuildOutput> {
        return self.client.execute(operation: "UpdateBuild", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func updateBuild(_ input: UpdateBuildInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateBuildOutput {
        return try await self.client.execute(operation: "UpdateBuild", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateFleetAttributes(_ input: UpdateFleetAttributesInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateFleetAttributesOutput> {
        return self.client.execute(operation: "UpdateFleetAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func updateFleetAttributes(_ input: UpdateFleetAttributesInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateFleetAttributesOutput {
        return try await self.client.execute(operation: "UpdateFleetAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateFleetCapacity(_ input: UpdateFleetCapacityInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateFleetCapacityOutput> {
        return self.client.execute(operation: "UpdateFleetCapacity", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func updateFleetCapacity(_ input: UpdateFleetCapacityInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateFleetCapacityOutput {
        return try await self.client.execute(operation: "UpdateFleetCapacity", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Updates port settings for a fleet. To update settings, specify the fleet ID to be updated and list the permissions you want to update. List the permissions you want to add in InboundPermissionAuthorizations, and permissions you want to remove in InboundPermissionRevocations. Permissions to be removed must match existing fleet permissions. If successful, the fleet ID for the updated fleet is returned.  Learn more   Setting up GameLift Fleets   Related operations     CreateFleet     ListFleets     DeleteFleet     DescribeFleetAttributes    Update fleets:    UpdateFleetAttributes     UpdateFleetCapacity     UpdateFleetPortSettings     UpdateRuntimeConfiguration       StartFleetActions or StopFleetActions
    public func updateFleetPortSettings(_ input: UpdateFleetPortSettingsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateFleetPortSettingsOutput> {
        return self.client.execute(operation: "UpdateFleetPortSettings", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func updateFleetPortSettings(_ input: UpdateFleetPortSettingsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateFleetPortSettingsOutput {
        return try await self.client.execute(operation: "UpdateFleetPortSettings", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateGameServer(_ input: UpdateGameServerInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateGameServerOutput> {
        return self.client.execute(operation: "UpdateGameServer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func updateGameServer(_ input: UpdateGameServerInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateGameServerOutput {
        return try await self.client.execute(operation: "UpdateGameServer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateGameServerGroup(_ input: UpdateGameServerGroupInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateGameServerGroupOutput> {
        return self.client.execute(operation: "UpdateGameServerGroup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func updateGameServerGroup(_ input: UpdateGameServerGroupInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateGameServerGroupOutput {
        return try await self.client.execute(operation: "UpdateGameServerGroup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateGameSession(_ input: UpdateGameSessionInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateGameSessionOutput> {
        return self.client.execute(operation: "UpdateGameSession", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func updateGameSession(_ input: UpdateGameSessionInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateGameSessionOutput {
        return try await self.client.execute(operation: "UpdateGameSession", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateGameSessionQueue(_ input: UpdateGameSessionQueueInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateGameSessionQueueOutput> {
        return self.client.execute(operation: "UpdateGameSessionQueue", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func updateGameSessionQueue(_ input: UpdateGameSessionQueueInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateGameSessionQueueOutput {
        return try await self.client.execute(operation: "UpdateGameSessionQueue", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateMatchmakingConfiguration(_ input: UpdateMatchmakingConfigurationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateMatchmakingConfigurationOutput> {
        return self.client.execute(operation: "UpdateMatchmakingConfiguration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func updateMatchmakingConfiguration(_ input: UpdateMatchmakingConfigurationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateMatchmakingConfigurationOutput {
        return try await self.client.execute(operation: "UpdateMatchmakingConfiguration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateRuntimeConfiguration(_ input: UpdateRuntimeConfigurationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateRuntimeConfigurationOutput> {
        return self.client.execute(operation: "UpdateRuntimeConfiguration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func updateRuntimeConfiguration(_ input: UpdateRuntimeConfigurationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateRuntimeConfigurationOutput {
        return try await self.client.execute(operation: "UpdateRuntimeConfiguration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateScript(_ input: UpdateScriptInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateScriptOutput> {
        return self.client.execute(operation: "UpdateScript", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func updateScript(_ input: UpdateScriptInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateScriptOutput {
        return try await self.client.execute(operation: "UpdateScript", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func validateMatchmakingRuleSet(_ input: ValidateMatchmakingRuleSetInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ValidateMatchmakingRuleSetOutput> {
        return self.client.execute(operation: "ValidateMatchmakingRuleSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    public func validateMatchmakingRuleSet(_ input: ValidateMatchmakingRuleSetInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ValidateMatchmakingRuleSetOutput {
        return try await self.client.execute(operation: "ValidateMatchmakingRuleSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
}
