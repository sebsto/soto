...
public struct Firehose: AWSService {
    ...
    public func createDeliveryStream(_ input: CreateDeliveryStreamInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateDeliveryStreamOutput {
        return try await self.client.execute(operation: "CreateDeliveryStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteDeliveryStream(_ input: DeleteDeliveryStreamInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteDeliveryStreamOutput {
        return try await self.client.execute(operation: "DeleteDeliveryStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeDeliveryStream(_ input: DescribeDeliveryStreamInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeDeliveryStreamOutput {
        return try await self.client.execute(operation: "DescribeDeliveryStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listDeliveryStreams(_ input: ListDeliveryStreamsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListDeliveryStreamsOutput {
        return try await self.client.execute(operation: "ListDeliveryStreams", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listTagsForDeliveryStream(_ input: ListTagsForDeliveryStreamInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListTagsForDeliveryStreamOutput {
        return try await self.client.execute(operation: "ListTagsForDeliveryStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func putRecordBatch(_ input: PutRecordBatchInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> PutRecordBatchOutput {
        return try await self.client.execute(operation: "PutRecordBatch", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func startDeliveryStreamEncryption(_ input: StartDeliveryStreamEncryptionInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> StartDeliveryStreamEncryptionOutput {
        return try await self.client.execute(operation: "StartDeliveryStreamEncryption", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func stopDeliveryStreamEncryption(_ input: StopDeliveryStreamEncryptionInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> StopDeliveryStreamEncryptionOutput {
        return try await self.client.execute(operation: "StopDeliveryStreamEncryption", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func tagDeliveryStream(_ input: TagDeliveryStreamInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> TagDeliveryStreamOutput {
        return try await self.client.execute(operation: "TagDeliveryStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func untagDeliveryStream(_ input: UntagDeliveryStreamInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UntagDeliveryStreamOutput {
        return try await self.client.execute(operation: "UntagDeliveryStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateDestination(_ input: UpdateDestinationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateDestinationOutput {
        return try await self.client.execute(operation: "UpdateDestination", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
}
