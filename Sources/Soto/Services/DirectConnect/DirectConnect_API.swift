...
public struct DirectConnect: AWSService {
    ...
    public func acceptDirectConnectGatewayAssociationProposal(_ input: AcceptDirectConnectGatewayAssociationProposalRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> AcceptDirectConnectGatewayAssociationProposalResult {
        return try await self.client.execute(operation: "AcceptDirectConnectGatewayAssociationProposal", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    @available(*, deprecated, message: "AllocateConnectionOnInterconnect is deprecated.")
    public func allocateConnectionOnInterconnect(_ input: AllocateConnectionOnInterconnectRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> Connection {
        return try await self.client.execute(operation: "AllocateConnectionOnInterconnect", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func allocateHostedConnection(_ input: AllocateHostedConnectionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> Connection {
        return try await self.client.execute(operation: "AllocateHostedConnection", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func allocatePrivateVirtualInterface(_ input: AllocatePrivateVirtualInterfaceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> VirtualInterface {
        return try await self.client.execute(operation: "AllocatePrivateVirtualInterface", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func allocatePublicVirtualInterface(_ input: AllocatePublicVirtualInterfaceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> VirtualInterface {
        return try await self.client.execute(operation: "AllocatePublicVirtualInterface", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func allocateTransitVirtualInterface(_ input: AllocateTransitVirtualInterfaceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> AllocateTransitVirtualInterfaceResult {
        return try await self.client.execute(operation: "AllocateTransitVirtualInterface", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func associateConnectionWithLag(_ input: AssociateConnectionWithLagRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> Connection {
        return try await self.client.execute(operation: "AssociateConnectionWithLag", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func associateHostedConnection(_ input: AssociateHostedConnectionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> Connection {
        return try await self.client.execute(operation: "AssociateHostedConnection", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func associateVirtualInterface(_ input: AssociateVirtualInterfaceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> VirtualInterface {
        return try await self.client.execute(operation: "AssociateVirtualInterface", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func confirmConnection(_ input: ConfirmConnectionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ConfirmConnectionResponse {
        return try await self.client.execute(operation: "ConfirmConnection", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func confirmPrivateVirtualInterface(_ input: ConfirmPrivateVirtualInterfaceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ConfirmPrivateVirtualInterfaceResponse {
        return try await self.client.execute(operation: "ConfirmPrivateVirtualInterface", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func confirmPublicVirtualInterface(_ input: ConfirmPublicVirtualInterfaceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ConfirmPublicVirtualInterfaceResponse {
        return try await self.client.execute(operation: "ConfirmPublicVirtualInterface", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func confirmTransitVirtualInterface(_ input: ConfirmTransitVirtualInterfaceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ConfirmTransitVirtualInterfaceResponse {
        return try await self.client.execute(operation: "ConfirmTransitVirtualInterface", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createBGPPeer(_ input: CreateBGPPeerRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateBGPPeerResponse {
        return try await self.client.execute(operation: "CreateBGPPeer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createConnection(_ input: CreateConnectionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> Connection {
    ...
    public func createDirectConnectGateway(_ input: CreateDirectConnectGatewayRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateDirectConnectGatewayResult {
        return try await self.client.execute(operation: "CreateDirectConnectGateway", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createDirectConnectGatewayAssociation(_ input: CreateDirectConnectGatewayAssociationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateDirectConnectGatewayAssociationResult {
        return try await self.client.execute(operation: "CreateDirectConnectGatewayAssociation", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createDirectConnectGatewayAssociationProposal(_ input: CreateDirectConnectGatewayAssociationProposalRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateDirectConnectGatewayAssociationProposalResult {
        return try await self.client.execute(operation: "CreateDirectConnectGatewayAssociationProposal", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createInterconnect(_ input: CreateInterconnectRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> Interconnect {
        return try await self.client.execute(operation: "CreateInterconnect", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createLag(_ input: CreateLagRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> Lag {
        return try await self.client.execute(operation: "CreateLag", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createPrivateVirtualInterface(_ input: CreatePrivateVirtualInterfaceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> VirtualInterface {
        return try await self.client.execute(operation: "CreatePrivateVirtualInterface", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createPublicVirtualInterface(_ input: CreatePublicVirtualInterfaceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> VirtualInterface {
        return try await self.client.execute(operation: "CreatePublicVirtualInterface", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createTransitVirtualInterface(_ input: CreateTransitVirtualInterfaceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateTransitVirtualInterfaceResult {
        return try await self.client.execute(operation: "CreateTransitVirtualInterface", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteBGPPeer(_ input: DeleteBGPPeerRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteBGPPeerResponse {
        return try await self.client.execute(operation: "DeleteBGPPeer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteConnection(_ input: DeleteConnectionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> Connection {
    ...
    public func deleteDirectConnectGateway(_ input: DeleteDirectConnectGatewayRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteDirectConnectGatewayResult {
        return try await self.client.execute(operation: "DeleteDirectConnectGateway", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteDirectConnectGatewayAssociation(_ input: DeleteDirectConnectGatewayAssociationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteDirectConnectGatewayAssociationResult {
        return try await self.client.execute(operation: "DeleteDirectConnectGatewayAssociation", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteDirectConnectGatewayAssociationProposal(_ input: DeleteDirectConnectGatewayAssociationProposalRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteDirectConnectGatewayAssociationProposalResult {
        return try await self.client.execute(operation: "DeleteDirectConnectGatewayAssociationProposal", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteInterconnect(_ input: DeleteInterconnectRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteInterconnectResponse {
        return try await self.client.execute(operation: "DeleteInterconnect", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteLag(_ input: DeleteLagRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> Lag {
        return try await self.client.execute(operation: "DeleteLag", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteVirtualInterface(_ input: DeleteVirtualInterfaceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteVirtualInterfaceResponse {
        return try await self.client.execute(operation: "DeleteVirtualInterface", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    @available(*, deprecated, message: "DescribeConnectionLoa is deprecated.")
    public func describeConnectionLoa(_ input: DescribeConnectionLoaRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeConnectionLoaResponse {
        return try await self.client.execute(operation: "DescribeConnectionLoa", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeConnections(_ input: DescribeConnectionsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> Connections {
    ...
    @available(*, deprecated, message: "DescribeConnectionsOnInterconnect is deprecated.")
    public func describeConnectionsOnInterconnect(_ input: DescribeConnectionsOnInterconnectRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> Connections {
        return try await self.client.execute(operation: "DescribeConnectionsOnInterconnect", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeDirectConnectGatewayAssociationProposals(_ input: DescribeDirectConnectGatewayAssociationProposalsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeDirectConnectGatewayAssociationProposalsResult {
        return try await self.client.execute(operation: "DescribeDirectConnectGatewayAssociationProposals", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeDirectConnectGatewayAssociations(_ input: DescribeDirectConnectGatewayAssociationsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeDirectConnectGatewayAssociationsResult {
        return try await self.client.execute(operation: "DescribeDirectConnectGatewayAssociations", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeDirectConnectGatewayAttachments(_ input: DescribeDirectConnectGatewayAttachmentsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeDirectConnectGatewayAttachmentsResult {
        return try await self.client.execute(operation: "DescribeDirectConnectGatewayAttachments", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeDirectConnectGateways(_ input: DescribeDirectConnectGatewaysRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeDirectConnectGatewaysResult {
        return try await self.client.execute(operation: "DescribeDirectConnectGateways", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeHostedConnections(_ input: DescribeHostedConnectionsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> Connections {
        return try await self.client.execute(operation: "DescribeHostedConnections", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    @available(*, deprecated, message: "DescribeInterconnectLoa is deprecated.")
    public func describeInterconnectLoa(_ input: DescribeInterconnectLoaRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeInterconnectLoaResponse {
        return try await self.client.execute(operation: "DescribeInterconnectLoa", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeInterconnects(_ input: DescribeInterconnectsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> Interconnects {
        return try await self.client.execute(operation: "DescribeInterconnects", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeLags(_ input: DescribeLagsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> Lags {
        return try await self.client.execute(operation: "DescribeLags", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeLoa(_ input: DescribeLoaRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> Loa {
        return try await self.client.execute(operation: "DescribeLoa", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeLocations(logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> Locations {
        return try await self.client.execute(operation: "DescribeLocations", path: "/", httpMethod: .POST, serviceConfig: self.config, logger: logger, on: eventLoop)
    }
    ...
    public func describeVirtualGateways(logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> VirtualGateways {
        return try await self.client.execute(operation: "DescribeVirtualGateways", path: "/", httpMethod: .POST, serviceConfig: self.config, logger: logger, on: eventLoop)
    }
    ...
    public func describeVirtualInterfaces(_ input: DescribeVirtualInterfacesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> VirtualInterfaces {
        return try await self.client.execute(operation: "DescribeVirtualInterfaces", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func disassociateConnectionFromLag(_ input: DisassociateConnectionFromLagRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> Connection {
        return try await self.client.execute(operation: "DisassociateConnectionFromLag", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listVirtualInterfaceTestHistory(_ input: ListVirtualInterfaceTestHistoryRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListVirtualInterfaceTestHistoryResponse {
        return try await self.client.execute(operation: "ListVirtualInterfaceTestHistory", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func startBgpFailoverTest(_ input: StartBgpFailoverTestRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> StartBgpFailoverTestResponse {
        return try await self.client.execute(operation: "StartBgpFailoverTest", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func stopBgpFailoverTest(_ input: StopBgpFailoverTestRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> StopBgpFailoverTestResponse {
        return try await self.client.execute(operation: "StopBgpFailoverTest", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateDirectConnectGatewayAssociation(_ input: UpdateDirectConnectGatewayAssociationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateDirectConnectGatewayAssociationResult {
        return try await self.client.execute(operation: "UpdateDirectConnectGatewayAssociation", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateLag(_ input: UpdateLagRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> Lag {
