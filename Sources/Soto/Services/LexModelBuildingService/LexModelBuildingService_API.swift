...
public struct LexModelBuildingService: AWSService {
    ...
    public func deleteBotChannelAssociation(_ input: DeleteBotChannelAssociationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws {
        return try await self.client.execute(operation: "DeleteBotChannelAssociation", path: "/bots/{botName}/aliases/{aliasName}/channels/{name}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getBotChannelAssociation(_ input: GetBotChannelAssociationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetBotChannelAssociationResponse {
        return try await self.client.execute(operation: "GetBotChannelAssociation", path: "/bots/{botName}/aliases/{aliasName}/channels/{name}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getBotChannelAssociations(_ input: GetBotChannelAssociationsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetBotChannelAssociationsResponse {
        return try await self.client.execute(operation: "GetBotChannelAssociations", path: "/bots/{botName}/aliases/{aliasName}/channels/", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
